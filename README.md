# Portfolio V5 - Eshwar Akhilesh Chowdary  

A modern, responsive portfolio website built with React.js and Vite, featuring stunning animations, dark theme, and optimized performance.
...
**Live Demo:**  
Deployed on Vercel - [Portfolio Link](https://your-vercel-domain.vercel.app/)  
...
Add any environment variables in your Vercel dashboard:
- `VITE_API_KEY` (if using external APIs)
- `VITE_FIREBASE_CONFIG` (if using Firebase)
